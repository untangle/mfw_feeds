...
```
docker-compose -f docker-compose.build.yml run build (-d x86_64|wrt1900|wrt3200|omnia, -l musl|glibc)
```
...
```
docker-compose -f docker-compose.build.yml run build (-d x86_64|wrt1900|wrt3200|omnia, -l musl|glibc) -m "-j1 V=s"
```
